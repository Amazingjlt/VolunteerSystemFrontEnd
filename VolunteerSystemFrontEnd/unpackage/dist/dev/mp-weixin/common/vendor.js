...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "",
    appName: "VolunteerSystemFrontEnd",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function getPx$1(value, unit = false) {
  if (number$1(value)) {
...
function addStyle$1(customStyle, target = "object") {
  if (empty$2(customStyle) || typeof customStyle === "object" && target === "object" || target === "string" && typeof customStyle === "string") {
    return customStyle;
  }
  if (target === "object") {
...
function getDuration$1(value, unit = true) {
...
function padZero$1(value) {
  return `00${value}`.slice(-2);
}
function formValidate$1(instance, event) {
  const formItem2 = $parent$1.call(instance, "u-form-item");
  const form2 = $parent$1.call(instance, "u-form");
  if (formItem2 && form2) {
...
function buildURL$1(url2, params) {
  if (!params) {
    return url2;
  }
  let serializedParams;
  if (isURLSearchParams$1(params)) {
    serializedParams = params.toString();
  } else {
    const parts = [];
    forEach$1(params, (val, key) => {
...
const adapter$1 = (config2) => new Promise((resolve2, reject) => {
  ...
  if (config2.method === "UPLOAD") {
    ...
    requestTask = index$2.uploadFile({ ..._config, ...otherConfig, ...mergeKeys$3(optionalKeys, config2) });
    ...
    requestTask = index$2.request({ ..._config, ...mergeKeys$3(optionalKeys, config2) });
  }
  if (config2.getTask) {
...
function colorGradient$2(startColor = "rgb(0, 0, 0)", endColor = "rgb(255, 255, 255)", step = 10) {
...
function colorToRgba$1(color2, alpha) {
...
const colorGradient$3 = {
  colorGradient: colorGradient$2,
  hexToRgb: hexToRgb$1,
  rgbToHex: rgbToHex$1,
  colorToRgba: colorToRgba$1
};
let timeout$1 = null;
...
function setConfig$1(configs) {
  index$1.shallowMerge(config$1, configs.config || {});
  index$1.shallowMerge(defProps, configs.props || {});
  index$1.shallowMerge(color$4, configs.color || {});
  index$1.shallowMerge(zIndex$1, configs.zIndex || {});
}
index$1.setConfig = setConfig$1;
const $u$1 = {
  route: route$1,
  date: index$1.timeFormat,
  // 另名date
  colorGradient: colorGradient$3.colorGradient,
  hexToRgb: colorGradient$3.hexToRgb,
  rgbToHex: colorGradient$3.rgbToHex,
  colorToRgba: colorGradient$3.colorToRgba,
  test: test$1,
  type: themeType,
  http,
  config: config$1,
...
const install = (Vue) => {
  index$2.$u = $u$1;
  Vue.config.globalProperties.$u = $u$1;
  Vue.mixin(mixin$2);
};
const uviewPlus = {
  install
...
var progress_min = { exports: {} };
(function(module2, exports2) {
  var e2;
  e2 = function() {
    return i = {}, o2.m = n2 = [function(t2, e3, n3) {
      function i2(e4, t3) {
        var n4, i3 = Object.keys(e4);
        return Object.getOwnPropertySymbols && (n4 = Object.getOwnPropertySymbols(e4), t3 && (n4 = n4.filter(function(t4) {
          return Object.getOwnPropertyDescriptor(e4, t4).enumerable;
        })), i3.push.apply(i3, n4)), i3;
      }
      function o3(o4) {
        for (var t3 = 1; t3 < arguments.length; t3++) {
          var r2 = null != arguments[t3] ? arguments[t3] : {};
          t3 % 2 ? i2(Object(r2), true).forEach(function(t4) {
            var e4, n4, i3;
            e4 = o4, i3 = r2[n4 = t4], n4 in e4 ? Object.defineProperty(e4, n4, { value: i3, enumerable: true, configurable: true, writable: true }) : e4[n4] = i3;
          }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(o4, Object.getOwnPropertyDescriptors(r2)) : i2(Object(r2)).forEach(function(t4) {
            Object.defineProperty(o4, t4, Object.getOwnPropertyDescriptor(r2, t4));
          });
        }
        return o4;
      }
      ...
      var s2 = function() {
        function u(t4) {
          ...
          var e5 = t4.canvasId, n4 = t4.canvasSize, i3 = void 0 === n4 ? { width: 400, height: 400 } : n4, o4 = t4.percent, r2 = void 0 === o4 ? 100 : o4, s3 = t4.barStyle, a = void 0 === s3 ? {} : s3, h = t4.needDot, c = void 0 !== h && h, l = t4.dotStyle, d = void 0 === l ? [] : l, p2 = t4.target, f2 = void 0 === p2 ? null : p2;
          if (!e5)
            throw "[初始化失败]: 缺少canvasId";
          this._percent = r2 < 50 ? 50 : 100 < r2 ? 100 : r2, this._options = { canvasId: e5, needDot: c, dotStyle: d, canvasSize: i3, barStyle: a, target: f2 }, this._barIndex = 0, this.isInit = false;
        }
        var t3, e4;
        return t3 = u, (e4 = [{ key: "draw", value: function(t4) {
          var o4 = this, e5 = wx$1.getSystemInfoSync().SDKVersion;
          if (this.compareVersion(e5, "2.7.0") < 0)
            console.error("请在2.7.0以上的SDK中使用，当前SDK版本：".concat(e5));
          else if (void 0 !== t4)
            if (t4 < 0 && (t4 = 0, console.warn("[参数percentagegit<0]: 已自动调整为0")), 100 < t4 && (t4 = 100, console.warn("[参数percentage>100]: 已自动调整为100")), this._options.percentage = +t4 || 0, this._context)
              this.drawFn();
            else
              try {
                var n4 = this._options.target, i3 = wx$1.createSelectorQuery().in(n4);
                n4.$wx && n4.$wx.$wepy && (i3 = wx$1.createSelectorQuery()), i3.select("#".concat(this._options.canvasId)).node(function(t5) {
                  var e6 = t5.node;
                  o4._requestAnimationFrame = e6.requestAnimationFrame.bind(e6);
                  var n5 = e6.getContext("2d"), i4 = wx$1.getSystemInfoSync().pixelRatio;
                  e6.width = e6._width * i4, e6.height = e6._height * i4, n5.scale(i4, i4), o4._context = n5, o4.drawFn();
                }).exec();
              } catch (t5) {
                console.warn(t5);
              }
        ...
        } }, { key: "drawFn", value: function() {
          var n4 = this;
          try {
            var t4 = this._options.barStyle;
            if (0 < t4.length) {
              if (this.isInit)
                this._positionInfo, 100 === this._percent ? this._context.clearRect(-this._positionInfo.originX, -this._positionInfo.originY, this.convertLength(this._options.canvasSize.width), this.convertLength(this._options.canvasSize.height)) : this._context.clearRect(-this._positionInfo.originX, -this.convertLength(this._options.canvasSize.height) / 2, this.convertLength(this._options.canvasSize.width), this.convertLength(this._options.canvasSize.height)), this._context.shadowColor = "transparent", this._context.shadowBlur = 0;
              else {
                for (var e5 = 0, i3 = 0; i3 < t4.length; i3++) {
                  var o4 = t4[i3].width;
                  e5 < o4 && (e5 = o4);
                }
                var r2 = 0, s3 = Math.cos(2 * Math.PI / 360 * ((100 - this._percent) / 2 / 100 * 360)), r2 = 100 === this._percent ? ((Math.min(this._options.canvasSize.width, this._options.canvasSize.height) - 2 * e5) / 2).toFixed(2) : (Math.min(this._options.canvasSize.width / 2, (this._options.canvasSize.height - 2 * e5) / (1 + s3)) - e5).toFixed(2), a = Math.round(this._options.canvasSize.width / 2), h = 0, h = 100 === this._percent ? Math.round(this._options.canvasSize.height / 2) : Math.round(this._options.canvasSize.height / (1 + s3));
                if (this.isInit = true, this._options.needDot) {
                  if (!(0 < this._options.dotStyle.length))
                    return void console.warn("参数dotStyle不完整，请检查");
                  var c, l = this._options.dotStyle[0].r;
                  e5 < 2 * l && (r2 -= l - e5 + (c = this._options.dotStyle[0].shadow ? l / 4 : 0), 100 !== this._percent && (h -= l + c));
                }
                this.convertLength(a), this.convertLength(h);
                var d = 100 === this._percent ? -90 : 360 * ((100 - this._percent + (this._percent - 50) / 2) / 100).toFixed(2);
                this._positionInfo = { originX: this.convertLength(a), originY: this.convertLength(h) }, this._context.translate(this._positionInfo.originX, this._positionInfo.originY), this._context.rotate(d * Math.PI / 180), this._r = this.convertLength(r2);
              }
              this.deg = 2 * (this._options.percentage / 100).toFixed(2) * Math.PI, (t4 || []).forEach(function(t5, e6) {
                t5.percent = 0, n4._barIndex = e6, n4.drawBar();
              }), this.hasAnimateBar ? console.warn("animate和dotStyle不可同时使用") : this._options.needDot && this.drawBarCoordinateDot();
            } else
              console.warn("参数barStyle不符合要求，请检查");
          } catch (t5) {
            console.warn("[绘图过程出现错误]: ", t5);
          }
        } }, { key: "drawBar", value: function() {
          var t4 = this._options.barStyle[this._barIndex], e5 = this._options.barStyle.length - 1 === this._barIndex, n4 = (e5 ? this.deg : 2 * Math.PI) * this._percent / 100, i3 = n4;
          e5 && t4.animate && t4.percent < 100 && (this.hasAnimateBar = true, t4.percent ? t4.percent += 2 : t4.percent = 2, i3 = n4 * (t4.percent / 100)), this._context.beginPath(), this._context.arc(0, 0, this._r, 0, i3), this._context.lineWidth = this.convertLength(t4.width), this._context.strokeStyle = this.generateBarFillStyle(t4.fillStyle);
          var o4 = t4.lineCap;
          o4 && (this._context.lineCap = o4), this._context.stroke(), e5 && t4.animate && t4.percent < 100 && this._requestAnimationFrame(this.drawBar.bind(this));
        } }, { key: "compareVersion", value: function(t4, e5) {
          t4 = t4.split("."), e5 = e5.split(".");
          for (var n4 = Math.max(t4.length, e5.length); t4.length < n4; )
            t4.push("0");
          for (; e5.length < n4; )
            e5.push("0");
          for (var i3 = 0; i3 < n4; i3++) {
            var o4 = parseInt(t4[i3]), r2 = parseInt(e5[i3]);
            if (r2 < o4)
              return 1;
            if (o4 < r2)
              return -1;
          ...
          return 0;
        } }, { key: "generateBarFillStyle", value: function(t4) {
          if ("string" == typeof t4)
            return t4;
          for (var e5 = this._context.createLinearGradient(0, 0, 100, 90), n4 = 0; n4 < t4.length; n4++) {
            var i3 = t4[n4];
            e5.addColorStop(i3.position, i3.color);
          }
          return e5;
        } }, { key: "convertLength", value: function(t4) {
          return +Math.round(wx$1.getSystemInfoSync().windowWidth * t4 / 750);
        } }, { key: "drawCircleWithFillStyle", value: function(t4) {
          this._context.beginPath(), this._context.arc(t4.x, t4.y, this.convertLength(t4.r), 0, 2 * Math.PI), this._context.fillStyle = t4.fillStyle || "#ffffff", t4.shadow && (this._context.shadowOffsetX = 0, this._context.shadowOffsetY = 0, this._context.shadowColor = t4.shadow, this._context.shadowBlur = this.convertLength(t4.r / 2)), this._context.fill();
        } }, { key: "drawBarCoordinateDot", value: function() {
          var t4 = 360 * (this._options.percentage / 100 * this._percent / 100).toFixed(2), e5 = "", n4 = 0, i3 = 0, i3 = t4 <= 90 ? (e5 = 2 * Math.PI / 360 * t4, n4 = (Math.cos(e5) * this._r).toFixed(2), (Math.sin(e5) * this._r).toFixed(2)) : 90 < t4 && t4 <= 180 ? (e5 = 2 * Math.PI / 360 * (180 - t4), n4 = -(Math.cos(e5) * this._r).toFixed(2), (Math.sin(e5) * this._r).toFixed(2)) : (n4 = 180 < t4 && t4 <= 270 ? (e5 = 2 * Math.PI / 360 * (t4 - 180), -(Math.cos(e5) * this._r).toFixed(2)) : (e5 = 2 * Math.PI / 360 * (360 - t4), (Math.cos(e5) * this._r).toFixed(2)), -(Math.sin(e5) * this._r).toFixed(2));
          0 < this._options.dotStyle.length ? this.drawCircleWithFillStyle(o3({ x: n4, y: i3 }, this._options.dotStyle[0])) : console.warn("参数dotStyle不完整，请检查"), 1 < this._options.dotStyle.length && this.drawCircleWithFillStyle(o3({ x: n4, y: i3 }, this._options.dotStyle[1]));
        } }]) && r(t3.prototype, e4), u;
      }();
      e3.default = s2;
    }], o2.c = i, o2.d = function(t2, e3, n3) {
      o2.o(t2, e3) || Object.defineProperty(t2, e3, { enumerable: true, get: n3 });
    }, o2.r = function(t2) {
      "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t2, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t2, "__esModule", { value: true });
    }, o2.t = function(e3, t2) {
      if (1 & t2 && (e3 = o2(e3)), 8 & t2)
        return e3;
      if (4 & t2 && "object" == typeof e3 && e3 && e3.__esModule)
        return e3;
      var n3 = /* @__PURE__ */ Object.create(null);
      if (o2.r(n3), Object.defineProperty(n3, "default", { enumerable: true, value: e3 }), 2 & t2 && "string" != typeof e3)
        for (var i2 in e3)
          o2.d(n3, i2, (function(t3) {
            return e3[t3];
          }).bind(null, i2));
      return n3;
    }, o2.n = function(t2) {
    ...
    }, o2.p = "", o2(o2.s = 0).default;
    function o2(t2) {
      if (i[t2])
        return i[t2].exports;
      var e3 = i[t2] = { i: t2, l: false, exports: {} };
      return n2[t2].call(e3.exports, e3, e3.exports, o2), e3.l = true, e3.exports;
    }
    var n2, i;
  }, module2.exports = e2();
})(progress_min);
var progress_minExports = progress_min.exports;
const MpProgress = /* @__PURE__ */ getDefaultExportFromCjs(progress_minExports);
var mixin = {
  // 定义每个组件都可能需要用到的外部样式以及类名
  props: {
    // 每个组件都有的父组件传递的样式，可以为字符串或者对象形式
